...
class Mastery:
    ...
    def __init__(self):
        ...
        self.concepts = ['Abstraction', 'Parallelism', 'Logic', 'Synchronization',
    ...
    def parallelism(self):
        ...
        elif self.blocks_dicc['event_whenbackdropswitchesto'] > 1:
        ...
        elif self.blocks_dicc['event_whengreaterthan'] > 1:
            if dict_parall['WHENGREATERTHANMENU']:
                ...
                for var in var_list:
                    if dict_parall['WHENGREATERTHANMENU'].count(var) > 1:
                        self.mastery_dicc['Parallelism'][3] = True
        # 2 Scripts start on the same multimedia (video) event
        elif self.blocks_dicc['videoSensing_whenMotionGreaterThan'] > 1:
            self.mastery_dicc['Parallelism'][3] = True
        ...
        elif self.blocks_dicc['event_whenthisspriteclicked'] > 1:
            self.mastery_dicc['Parallelism'][2] = True
